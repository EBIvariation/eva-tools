    ...
    public void setUp() throws Exception {
        ...
        matchingAllelesVariants.add(
                new SubSnpCoreFields(26201546L, Orientation.FORWARD, 13677177L, Orientation.FORWARD, "NT_455866.1",
                                     ...
                                     1766472L, Orientation.FORWARD, null, null, "batch"));
        matchingAllelesVariants.add(
        ...
        matchingAllelesVariants.add(
                new SubSnpCoreFields(0, Orientation.REVERSE, 0L, Orientation.FORWARD, "", 0L, 0L, Orientation.FORWARD,
                                     ...
                                     Orientation.FORWARD, "", 0L, 0L, Orientation.FORWARD, null, null, "batch"));
        matchingAllelesVariants.add(
                new SubSnpCoreFields(0, Orientation.REVERSE, 0L, Orientation.FORWARD, "", 0L, 0L, Orientation.FORWARD,
        ...
        mismatchingAllelesVariants.add(
                new SubSnpCoreFields(26201546, Orientation.FORWARD, 13677177L, Orientation.FORWARD, "NT_455866.1",
