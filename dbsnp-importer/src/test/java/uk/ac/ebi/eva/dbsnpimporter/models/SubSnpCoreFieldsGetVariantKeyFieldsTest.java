...
public class SubSnpCoreFieldsGetVariantKeyFieldsTest {
    ...
    public void snpCoordinatesMustNotChange() throws Exception {
        SubSnpCoreFields snp = new SubSnpCoreFields(1092414368L, 526595372L, 1, "NW_003104285.1", 12108029L, 12108029L,
                                                    1, LocusType.SNP.intValue(), "10", 100002924L, 100002924L, "C", "C",
                                                    "T", null, "AC_000167.1:g.100002924C>T", 100002924L, 100002924L, 1,
                                                    "NW_003104285.1:g.12108029C>T", 12108029L, 12108029L, 1);

        assertEquals(new VariantKeyFields("10", 100002924L, "C", "T"), snp.getVariantKeyFields());
    }
    ...
    public void contigCoordinatesReturnedForSnpNotMappedToChromosome() throws Exception {
        SubSnpCoreFields snp = new SubSnpCoreFields(1107437104L, 524908995L, 1, "NW_003101163.1", 943L, 943L, 1,
                                                    LocusType.SNP.intValue(), null, null, null, null, "C", "A", null,
                                                    null, null, null, 1, "NW_003101163.1:g.943C>A", 943L, 943L, 1);

        assertEquals(new VariantKeyFields("NW_003101163.1", 943L, "C", "A"), snp.getVariantKeyFields());
    }

    @Test
    public void singleNucleotideDeletionCoordinatesShouldNotChange() throws Exception {
        SubSnpCoreFields deletion = new SubSnpCoreFields(1093365488L, 433288923L, 1, "4332889n23", 1591551L, 1591551L,
                                                         1, LocusType.SNP.intValue(), "12", 10144047L, 10144047L, "G",
                                                         "G", null, null, "AC_000169.1:g.10144047delG", 10144047L,
                                                         10144047L, 1, "AC_000169.1:g.10144047delG", 1591551L, 1591551L,
                                                         1);

        assertEquals(new VariantKeyFields("12", 10144047L, "G", ""), deletion.getVariantKeyFields());
    }
    ...
    public void multiNucleotideDeletionCoordinatesShouldNotChange() throws Exception {
        ...
        assertEquals(new VariantKeyFields("2", 100306584L, "TCA", ""), deletion.getVariantKeyFields());
    }
    ...
    public void contigCoordinatesReturnedForDeletionNotMappedToChromosome() throws Exception {
        SubSnpCoreFields deletion = new SubSnpCoreFields(1107437081L, 524371323L, 1, "NW_003101162.1", 229L, 232L, 1,
                                                         LocusType.DELETION.intValue(), null, null, null, null, "TTTC",
                                                         null, null, null, null, null, 1,
                                                         "NW_003101162.1:g.229_232delTTTC", 229L, 232L, 1);

        assertEquals(new VariantKeyFields("NW_003101162.1", 229L, "TTTC", ""), deletion.getVariantKeyFields());
    }
    ...
    public void singleNucleotideInsertionStartShouldBeAdjusted() throws Exception {
        SubSnpCoreFields insertion = new SubSnpCoreFields(1092414490L, 522748169L, 1, "NW_003104285.1", 12118757L,
                                                          12118758L, 1, LocusType.INSERTION.intValue(), "10",
        ...
        assertEquals(new VariantKeyFields("10", 100013653L, "-", "A"), insertion.getVariantKeyFields());
    ...
    public void multioNucleotideInsertionStartAndEndShouldBeAdjusted() throws Exception {
        SubSnpCoreFields insertion = new SubSnpCoreFields(1513871941L, 379115400L, 1, "NW_003103939.1", 12276L, 12277L,
                                                          1, LocusType.INSERTION.intValue(), "5", 100080173L,
        ...
        assertEquals(new VariantKeyFields("5", 100080174L, "-", "TTGCA"), insertion.getVariantKeyFields());
    }
    ...
    public void contigCoordinatesReturnedForInsertionNotMappedToChromosome() throws Exception {
        SubSnpCoreFields insertion = new SubSnpCoreFields(1107437080L, 520781897L, 1, "NW_003101162.1", 189L, 190L, 1,
                                                          LocusType.INSERTION.intValue(), null, null, null, null, "-",
                                                          "AA", "-/AA", null, null, null, 1,
                                                          "NW_003101162.1:g.189_190insAA", 189L, 190L, 1);

        assertEquals(new VariantKeyFields("NW_003101162.1", 190L, "-", "AA"), insertion.getVariantKeyFields());
