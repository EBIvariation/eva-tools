...
public class RenormalizationProcessor implements ItemProcessor<SubSnpCoreFields, SubSnpCoreFields> {
    ...
    @Override
    public SubSnpCoreFields process(SubSnpCoreFields item) throws Exception {
